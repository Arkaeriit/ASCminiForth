...
: BENCHMARK 11 22 33 TEST.. TEST.IF TEST.BEGIN.LOOP TEST.NESTED.IF TEST.NESTED.LOOP TEST.0= TEST.0< TEST.= TEST.DROP TEST.SWAP TEST.ROT TEST.DUP TEST.+ TEST.* TEST.*/ TEST.*/MOD TEST./ TEST./MOD TEST.MEM TEST.CMEM TEST.BASE_RECORD TEST.BASE_PRINT
." Printing 33: " . CR ;
