...
: TEST., ." Testing , " HERE 64 , @ 64 = is_true CR ;
...
TEST.DROP TEST.SWAP TEST.ROT TEST.DUP TEST.2D TEST.R TEST.NIP TEST.OVER TEST.?DUP TEST.2OVER TEST.2SWAP
TEST.+ TEST.* TEST.*/ TEST.*/MOD TEST./ TEST./MOD TEST.< TEST.> TEST.MAX TEST.MIN TEST.NEGATE TEST.+!
TEST.MEM TEST.CMEM TEST., TEST.ALIGN
