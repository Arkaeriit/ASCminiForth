...
sef_error sef_compile_user_word(struct forth_dictionary_s* fd, const char* name, size_t subword_n, char** subwords, int base, hash_t force_hash);
sef_error sef_compile_string(struct forth_dictionary_s* fs, const char* name, const char* str, int base, hash_t force_hash);
